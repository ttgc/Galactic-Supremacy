...
public class SettingsRoom extends BasicGameState {
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
		...
		g.setColor(new Color(0,0,0));
		FontUtils.drawCenter(Level.fonts[1], "Retour", 64, (int) (posy_min+button.getHeight()/2), button.getWidth(), g.getColor());
		FontUtils.drawCenter(Level.fonts[1], "Par defaut", (int) (64+button.getWidth()+inter), (int) (posy_min+button.getHeight()/2), button.getWidth(), g.getColor());
